...
const ::uint32_t
    TableStruct_message_2eproto::offsets[] ABSL_ATTRIBUTE_SECTION_VARIABLE(
        ...
        PROTOBUF_FIELD_OFFSET(::message::GetChatServerRsp, _impl_.chatserver_),
        ...
        PROTOBUF_FIELD_OFFSET(::message::LoginReq, _impl_.chatserver_),
        ~0u,  // no _has_bits_
...
static const ::_pbi::MigrationSchema
    schemas[] ABSL_ATTRIBUTE_SECTION_VARIABLE(protodesc_cold) = {
        ...
        {61, -1, -1, sizeof(::message::AddFriendReq)},
        {76, -1, -1, sizeof(::message::AddFriendRsp)},
        {87, -1, -1, sizeof(::message::RplyFriendReq)},
        {98, -1, -1, sizeof(::message::RplyFriendRsp)},
        {109, -1, -1, sizeof(::message::SendChatMsgReq)},
        {120, -1, -1, sizeof(::message::SendChatMsgRsp)},
        {131, -1, -1, sizeof(::message::AuthFriendReq)},
        {141, -1, -1, sizeof(::message::AuthFriendRsp)},
        {152, -1, -1, sizeof(::message::TextChatMsgReq)},
        {163, -1, -1, sizeof(::message::TextChatData)},
        {173, -1, -1, sizeof(::message::TextChatMsgRsp)},
};
...
const char descriptor_table_protodef_message_2eproto[] ABSL_ATTRIBUTE_SECTION_VARIABLE(
    ...
    "\004port\030\003 \001(\t\022\022\n\nchatserver\030\004 \001(\t\022\r\n\005token"
    "\030\005 \001(\t\"+\n\010LoginReq\022\013\n\003uid\030\001 \001(\005\022\022\n\nchats"
    "erver\030\002 \001(\t\"\031\n\010LoginRsp\022\r\n\005error\030\001 \001(\005\"t"
    ...
    "tChatMsgReq\022\017\n\007fromuid\030\001 \001(\005\022\r\n\005touid\030\002 "
    "\001(\005\022\'\n\010textmsgs\030\003 \003(\0132\025.message.TextChat"
    "Data\"1\n\014TextChatData\022\r\n\005msgid\030\001 \001(\t\022\022\n\nm"
    "sgcontent\030\002 \001(\t\"h\n\016TextChatMsgRsp\022\r\n\005err"
    "or\030\001 \001(\005\022\017\n\007fromuid\030\002 \001(\005\022\r\n\005touid\030\003 \001(\005"
    "\022\'\n\010textmsgs\030\004 \003(\0132\025.message.TextChatDat"
    ...
    "eq\032\021.message.LoginRsp\"\0002\345\002\n\013ChatService\022"
...
inline PROTOBUF_NDEBUG_INLINE GetChatServerRsp::Impl_::Impl_(
    ...
    const Impl_& from, const ::message::GetChatServerRsp& from_msg)
      : host_(arena, from.host_),
        ...
        chatserver_(arena, from.chatserver_),
...
PROTOBUF_CONSTINIT PROTOBUF_ATTRIBUTE_INIT_PRIORITY1
const ::_pbi::TcParseTable<3, 5, 0, 56, 2> GetChatServerRsp::_table_ = {
  {
    0,  // no _has_bits_
    0, // no _extensions_
    ...
    // string chatserver = 4;
    {::_pbi::TcParser::FastUS1,
     {34, 63, 0, PROTOBUF_FIELD_OFFSET(GetChatServerRsp, _impl_.chatserver_)}},
    // string token = 5;
    {::_pbi::TcParser::FastUS1,
     {42, 63, 0, PROTOBUF_FIELD_OFFSET(GetChatServerRsp, _impl_.token_)}},
    {::_pbi::TcParser::MiniParse, {}},
    {::_pbi::TcParser::MiniParse, {}},
  }}, {{
    65535, 65535
    ...
    (0 | ::_fl::kFcSingular | ::_fl::kUtf8String | ::_fl::kRepAString)},
    // string chatserver = 4;
    {PROTOBUF_FIELD_OFFSET(GetChatServerRsp, _impl_.chatserver_), 0, 0,
    (0 | ::_fl::kFcSingular | ::_fl::kUtf8String | ::_fl::kRepAString)},
    // string token = 5;
...
::uint8_t* GetChatServerRsp::_InternalSerialize(
  ...
  // string chatserver = 4;
  if (!this->_internal_chatserver().empty()) {
    const std::string& _s = this->_internal_chatserver();
    ::google::protobuf::internal::WireFormatLite::VerifyUtf8String(
        _s.data(), static_cast<int>(_s.length()), ::google::protobuf::internal::WireFormatLite::SERIALIZE, "message.GetChatServerRsp.chatserver");
...
void GetChatServerRsp::MergeImpl(::google::protobuf::MessageLite& to_msg, const ::google::protobuf::MessageLite& from_msg) {
  ...
  if (!from._internal_chatserver().empty()) {
    _this->_internal_set_chatserver(from._internal_chatserver());
  }
...
void GetChatServerRsp::InternalSwap(GetChatServerRsp* PROTOBUF_RESTRICT other) {
  ...
  ::_pbi::ArenaStringPtr::InternalSwap(&_impl_.chatserver_, &other->_impl_.chatserver_, arena);
...
const ::_pbi::TcParseTable<1, 2, 0, 35, 2> LoginReq::_table_ = {
  {
    ...
    // string chatserver = 2;
    {::_pbi::TcParser::FastUS1,
     {18, 63, 0, PROTOBUF_FIELD_OFFSET(LoginReq, _impl_.chatserver_)}},
    // int32 uid = 1;
    ...
    (0 | ::_fl::kFcSingular | ::_fl::kInt32)},
    // string chatserver = 2;
    {PROTOBUF_FIELD_OFFSET(LoginReq, _impl_.chatserver_), 0, 0,
    (0 | ::_fl::kFcSingular | ::_fl::kUtf8String | ::_fl::kRepAString)},
  }},
  // no aux_entries
  {{
...
::uint8_t* LoginReq::_InternalSerialize(
  ...
  if (!this->_internal_chatserver().empty()) {
    const std::string& _s = this->_internal_chatserver();
    ::google::protobuf::internal::WireFormatLite::VerifyUtf8String(
        _s.data(), static_cast<int>(_s.length()), ::google::protobuf::internal::WireFormatLite::SERIALIZE, "message.LoginReq.chatserver");
    target = stream->WriteStringMaybeAliased(2, _s, target);
  }
