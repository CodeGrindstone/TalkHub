...
/* @@protoc_insertion_point(class_definition:message.LoginReq) */ {
 ...
 public:
  ...
  // accessors -------------------------------------------------------
  enum : int {
    kChatserverFieldNumber = 2,
    kUidFieldNumber = 1,
  };
  // string chatserver = 2;
  void clear_chatserver() ;
  const std::string& chatserver() const;
  template <typename Arg_ = const std::string&, typename... Args_>
  void set_chatserver(Arg_&& arg, Args_... args);
  std::string* mutable_chatserver();
  PROTOBUF_NODISCARD std::string* release_chatserver();
  void set_allocated_chatserver(std::string* value);

  private:
  const std::string& _internal_chatserver() const;
  inline PROTOBUF_ALWAYS_INLINE void _internal_set_chatserver(
      const std::string& value);
  std::string* _internal_mutable_chatserver();
 ...
 private:
  ...
  struct Impl_ {
    ...
    ::google::protobuf::internal::ArenaStringPtr chatserver_;
    ::int32_t uid_;
    mutable ::google::protobuf::internal::CachedSize _cached_size_;
    PROTOBUF_TSAN_DECLARE_MEMBER
  };
...
// string chatserver = 4;
inline void GetChatServerRsp::clear_chatserver() {
  ::google::protobuf::internal::TSanWrite(&_impl_);
  _impl_.chatserver_.ClearToEmpty();
}
inline const std::string& GetChatServerRsp::chatserver() const
    ABSL_ATTRIBUTE_LIFETIME_BOUND {
  // @@protoc_insertion_point(field_get:message.GetChatServerRsp.chatserver)
  return _internal_chatserver();
}
template <typename Arg_, typename... Args_>
inline PROTOBUF_ALWAYS_INLINE void GetChatServerRsp::set_chatserver(Arg_&& arg,
                                                     Args_... args) {
  ::google::protobuf::internal::TSanWrite(&_impl_);
  _impl_.chatserver_.Set(static_cast<Arg_&&>(arg), args..., GetArena());
  // @@protoc_insertion_point(field_set:message.GetChatServerRsp.chatserver)
}
inline std::string* GetChatServerRsp::mutable_chatserver() ABSL_ATTRIBUTE_LIFETIME_BOUND {
  std::string* _s = _internal_mutable_chatserver();
  // @@protoc_insertion_point(field_mutable:message.GetChatServerRsp.chatserver)
  return _s;
}
inline const std::string& GetChatServerRsp::_internal_chatserver() const {
  ::google::protobuf::internal::TSanRead(&_impl_);
  return _impl_.chatserver_.Get();
}
inline void GetChatServerRsp::_internal_set_chatserver(const std::string& value) {
  ::google::protobuf::internal::TSanWrite(&_impl_);
  _impl_.chatserver_.Set(value, GetArena());
}
inline std::string* GetChatServerRsp::_internal_mutable_chatserver() {
  ::google::protobuf::internal::TSanWrite(&_impl_);
  return _impl_.chatserver_.Mutable( GetArena());
}
inline std::string* GetChatServerRsp::release_chatserver() {
  ::google::protobuf::internal::TSanWrite(&_impl_);
  // @@protoc_insertion_point(field_release:message.GetChatServerRsp.chatserver)
  return _impl_.chatserver_.Release();
}
inline void GetChatServerRsp::set_allocated_chatserver(std::string* value) {
  ::google::protobuf::internal::TSanWrite(&_impl_);
  _impl_.chatserver_.SetAllocated(value, GetArena());
  #ifdef PROTOBUF_FORCE_COPY_DEFAULT_STRING
        if (_impl_.chatserver_.IsDefault()) {
          _impl_.chatserver_.Set("", GetArena());
        }
  #endif  // PROTOBUF_FORCE_COPY_DEFAULT_STRING
  // @@protoc_insertion_point(field_set_allocated:message.GetChatServerRsp.chatserver)
}
...
// string chatserver = 2;
inline void LoginReq::clear_chatserver() {
  ::google::protobuf::internal::TSanWrite(&_impl_);
  _impl_.chatserver_.ClearToEmpty();
}
inline const std::string& LoginReq::chatserver() const
    ABSL_ATTRIBUTE_LIFETIME_BOUND {
  // @@protoc_insertion_point(field_get:message.LoginReq.chatserver)
  return _internal_chatserver();
}
template <typename Arg_, typename... Args_>
inline PROTOBUF_ALWAYS_INLINE void LoginReq::set_chatserver(Arg_&& arg,
                                                     Args_... args) {
  ::google::protobuf::internal::TSanWrite(&_impl_);
  _impl_.chatserver_.Set(static_cast<Arg_&&>(arg), args..., GetArena());
  // @@protoc_insertion_point(field_set:message.LoginReq.chatserver)
}
inline std::string* LoginReq::mutable_chatserver() ABSL_ATTRIBUTE_LIFETIME_BOUND {
  std::string* _s = _internal_mutable_chatserver();
  // @@protoc_insertion_point(field_mutable:message.LoginReq.chatserver)
  return _s;
}
inline const std::string& LoginReq::_internal_chatserver() const {
  ::google::protobuf::internal::TSanRead(&_impl_);
  return _impl_.chatserver_.Get();
}
inline void LoginReq::_internal_set_chatserver(const std::string& value) {
  ::google::protobuf::internal::TSanWrite(&_impl_);
  _impl_.chatserver_.Set(value, GetArena());
}
inline std::string* LoginReq::_internal_mutable_chatserver() {
  ::google::protobuf::internal::TSanWrite(&_impl_);
  return _impl_.chatserver_.Mutable( GetArena());
}
inline std::string* LoginReq::release_chatserver() {
  ::google::protobuf::internal::TSanWrite(&_impl_);
  // @@protoc_insertion_point(field_release:message.LoginReq.chatserver)
  return _impl_.chatserver_.Release();
}
inline void LoginReq::set_allocated_chatserver(std::string* value) {
  ::google::protobuf::internal::TSanWrite(&_impl_);
  _impl_.chatserver_.SetAllocated(value, GetArena());
  #ifdef PROTOBUF_FORCE_COPY_DEFAULT_STRING
        if (_impl_.chatserver_.IsDefault()) {
  ...
  #endif  // PROTOBUF_FORCE_COPY_DEFAULT_STRING
  // @@protoc_insertion_point(field_set_allocated:message.LoginReq.chatserver)
}
